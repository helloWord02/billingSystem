                ...
                <!-- 查询  -->
                 ...
                 <div  >
                    ...
                    <form role="form" style="text-align: center">
                        ...
                        <span>权限名称：</span>
                        <input  style="margin-left: 20px;width: 200px;height: 30px; border: 1px rgba(105, 99, 70, 0.5) solid" placeholder="权限名称" name="name" type="text" id="name"><br><br>
                       <span>权限信息：</span>
                        <input  style="margin-left: 20px;width: 200px;height: 30px; border: 1px rgba(105, 99, 70, 0.5) solid" placeholder="权限信息" name="info" type="text" id="info"><br><br>
                        <button style="width: 100px;height: 40px" type="button" class="btn btn-info" id="add">添加</button>
...
<script >
	...
	$("#add").click(function(){
		...
		$.ajax({
			type:"post",
			url:"permission/add",
			data: {pername:$("#name").val()+"",perinfo:$("#info").val()+""},
			async:true,
