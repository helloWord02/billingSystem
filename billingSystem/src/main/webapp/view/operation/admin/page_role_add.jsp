                ...
                <!-- 查询  -->
                 ...
                 <div  >
                    ...
                    <form id="formtest" style="text-align: center">
                        ...
                        <span>角色名称：</span>
                        <input  style="margin-left: 20px;width: 200px;height: 30px; border: 1px rgba(105, 99, 70, 0.5) solid" placeholder="角色名称" name="rolename" type="text" id="name"><br><br>
                       <span>角色类型：</span>
...
test();
	$("#add").click(function(){
		...
		$.ajax({
			type:"post",
			url:"role/add",
			data: {rolename:$("#name").val()+"",type:$("#type").val()+"","pers[]": pers},
			async:true,
			success:function(data){
				if(data=="0"){
					alert("修改成功！");
