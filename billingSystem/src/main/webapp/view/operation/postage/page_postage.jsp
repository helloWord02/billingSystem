        ...
        <div class="div_content">
            ...
            <div class="panel-body">
               <!-- 查询 -->
                <div  >
                    <span>资费名称：</span>
                    <input  style="width: 140px;height: 30px; border: 1px rgba(105, 99, 70, 0.5) solid" placeholder="资费名称" name="name" type="text" >
                    <span>资费类型：</span>
                    <input  style=" width: 140px;height: 30px; border: 1px rgba(105, 99, 70, 0.5) solid" placeholder="资费类型" name="type" type="text" >
